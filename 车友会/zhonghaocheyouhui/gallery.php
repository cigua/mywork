...
<body>
	<div id="wrap">
    	...
    	<header id="mainheader">
        	<div class="top">
            	<a href="index.html"><h1>众豪车友会</h1></a>
				<div class="fl mar"><img src="images/wenzi01.png" alt="" /></div>
            ...
            <nav class="nav">
            	<ul>
                    ...
                    <li><a target="_blank" href="#">活动图片</a></li>
       ...
       <section id="constent">
					...
					<div class="act_case" >
						<div class="text">
							...
							<div class="gall">
								<dl>
									<dt>
									<a target="_blank"  href="gallery01.html">	
										<img class="img" src="images/img02.jpg" alt="" />
									</a>
									</dt>
									<dd><a>2017-07-02 车友会活动</a></dd>	
								</dl>
								<dl>
									<dt>
										<a target="_blank"  href="gallery01.html">	
			...
			<div class="right">		
				<div class="contect">
					<h2>车友活动</h2>     
					<dl><a href="#">
						<dt><img src="images/bonner06.jpg"></dt>
						<dd>车友会活动</dd>
						</a>
					</dl>
					<dl><a href="#">
