...
<body>
<h3>添加活动</h3>
<form action="doAdminAction.php?act=editAct&id=<?php echo $id;?>" method="post" enctype="multipart/form-data">
<table width="70%"  border="1" cellpadding="5" cellspacing="0" bgcolor="#cccccc">
	...
	<tr>
		...
		<td>
			<input type="text" name="pNum"  value="<?php echo $proInfo['pNum'];?>"/>——
			<input type="text" name="pNum"  value="<?php echo $proInfo['pNum'];?>"/>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><input type="text" name="iPrice"  value="<?php echo $proInfo['iDesc'];?>"/></td>
	</tr>
	<tr>
